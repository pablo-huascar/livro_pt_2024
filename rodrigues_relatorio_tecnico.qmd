...
Participaram do estudo 838 professores da educação básica de nove municípios do interior cearense. No que diz respeito a gênero, a maior parte da amostra era formada por mulheres (82,1%); já no que concerne a etnia, houve um número significativo de pessoas pretas (76,9%). Em relação ao estado civil, 49,8% afirmaram ser casados. No que diz respeito à formação, 57,4 % declararam ter concluído uma especialização. Sobre o nível de ensino, a maioria dos docentes atuava nos anos finais do ensino fundamental (41,8%).
...
sexo <- tibble(
  Variável = "Sexo", n = NA, "%" = NA
)

raca <- tibble(
  Variável = "Raça", n = NA, "%" = NA
)

est_civil <- tibble(
    Variável = "EStado civil", n = NA, "%" = NA

)

escol <- tibble(
    Variável = "Escolaridade", n = NA, "%" = NA
)

rend_pos <- 
  tibble(
        Variável = "Renda após o ínicio da pandemia", n = NA, "%" = NA
...
n_de_ens <- 
  tibble(
        Variável = "Nível de ensino", n = NA, "%" = NA
  )
