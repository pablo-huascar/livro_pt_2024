...
# “If I take the call and don't solve it, he thinks the problem is me”:  advisory report regarding an intervention in clinic of activity with customer service representatives

## Introduction

Customer service is pivotal in mediating the interests between organizations and their clients. While seemingly straightforward, it often leads to significant conflicts within the workplace. In the context of mediation work, diverse perceptions emerge, such as that of the institution, which aims to transform the service representative into a personification of the company's interests, and that of the user, who frequently overlooks the worker's individuality and holds them responsible for all their demands [@ferreira2000serv_atend_publico].

Call center operators, specifically, are provided with a script that delineates the procedures for interacting with the public. However, these workers report a discrepancy between the script and the realities they face in their roles, primarily due to unforeseen issues introduced by the users [@ziliotto_oliveira_2014].
...
Diante disso, o interesse recai sobre a história do desenvolvimento, assim como suas possibilidades, seus impedimentos e seus princípios. Portanto, os dispositivos técnicos utilizados na Clínica da Atividade, como autoconfrontação, instrução ao sósia, oficina de fotos [@osorio_pacheco_barros2013oficinas_fotos] e carta ao remetente, esta última recentemente desenvolvida por uma estudante do Mestrado Profissional em Psicologia e Políticas Públicas da Universidade Federal do Ceará e seus colaboradores [@Oliveira2022], atuam como mediadores e transformam, indiretamente, a atividade do sujeito, deslocando-as para um novo contexto. Os recursos utilizados autorizam uma reentrada na ação, por meio da linguagem, que reorganiza e modifica a atividade já realizada pelo indivíduo e pelo coletivo de trabalho [@clot2010trab_poder].

### Participantes

A @tbl-participantes apresenta a quantidade de atendentes que participaram do processo de intervenção, sendo nove mulheres e três homens. São apresentados, ainda, a idade dos trabalhadores, o tipo de atendimento que assumiam no setor, o tempo de carreira e o vínculo com a instituição.
...
Nessa intervenção, notaram-se forças e potencialidades. O grupo se mostrou engajado em todos os encontros e os trabalhadores se colocaram à frente das discussões, ocupando o lugar de experts sobre o ofício. Além disso, houve o reconhecimento por parte dos atendentes em relação à importância das trocas de experiências e de estratégias que ocorreram ao longo dos encontros para lidar com os impedimentos à atividade. Nesse bojo, os trabalhadores aprendiam uns com os outros, independente do tempo de trabalho na instituiçãondefined. Essa dinâmica aponta para uma ampliação no poder de agir dos participantes. Observou-se, também, que a intervenção proporcionou uma maior interação entre os profissionais das modalidades de atendimento presencial e online, uma vez que, cotidianamente, estes não possuíam um contato direto para que pudessem compartilhar e discutir os d
