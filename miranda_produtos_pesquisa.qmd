...
![](.\imagens\producao_pt_pesquisa_01.jpg){fig-alt="A imagem mostra uma pessoa de costas, observando uma exposição de folhas de papel afixadas em suportes presos por cordas, que aparentemente contêm textos e informações. A pessoa, vestindo uma camiseta branca e calça estampada, está lendo atentamente um dos papéis. Ao fundo, há uma parede com grafite colorido, onde se pode ler parcialmente a palavra \"AR\". A cena sugere que a pessoa está em uma exposição ao ar livre ou em um espaço informal, envolvida na leitura de materiais de pesquisa ou educativos que estão expostos em um varal de apresentações."}
...
![](.\imagens\producao_pt_pesquisa_02.jpg){fig-alt="A imagem mostra uma cena de um festival ao ar livre, possivelmente um evento comunitário ou cultural. No primeiro plano, há o topo da cabeça de uma pessoa com cabelo encaracolado, enquanto o foco principal é um pequeno palco improvisado onde três pessoas estão sentadas. À esquerda, uma criança está olhando atentamente, sentada no chão ao lado de uma cadeira vazia. No centro, uma mulher sentada em uma cadeira está segurando um microfone, vestindo uma camisa branca e um macacão laranja, exibindo uma expressão pensativa ou esperando para falar. À direita, um homem está sentado usando camisa azul e jeans. Por trás dos participantes, a parede branca está decorada com desenhos infantis e letras coloridas que anunciam \"Juventudes\", e acima há uma faixa com o texto \"Quarto festival das juventudes\". A configuração sugere um evento informal com foco na expressão cultural e na participação da comunidade. A estrutura aberta e as paredes desgastadas ao redor indicam que o evento pode estar ocorrendo em um espaço urbano revitalizado ou em um ambiente comunitário."}
...
Podcast é uma palavra que advém do laço criado entre Ipod (aparelho produzido pela Apple que reproduz mp3) e Broadcast (transmissão), podendo ser definido como um arquivo de áudio sobre qualquer tema ou área de conhecimento, disponibilizado em uma plataforma na internet, podendo ser produzido de forma amadora ou profissional. Além disso, o podcast se caracteriza por ser flexível em suas possibilidades de produção e transmissão, por se tratar de um conteúdo de fácil acesso pelos serviços de streamings, por ser totalmente gratuito e por possibilitar a qualquer pessoa com um aparelho celular e conexão à internet publicar o áudio. Dessa forma, fomenta a horizontalização do conhecimento ao ser partilhado por múltiplas discussões e autores, não se centrando em uma única figura [@barros2007podcast; @bezerra2022artes].
