...
Até o momento, foram desenvolvidos seis módulos para a oficina. Em breve, serão acrescentadas discussões sobre estatística descritiva e sobre análises mais básicas: correlação, test t, ANOVA, qui-quadrado e regressão. A seguir, são apresentados os módulos já elaborados e uma amostra do que é aprendido em cada um deles.
...
tmcs <- read_csv("https://tinyurl.com/contextosm")
```
