...
engine: knitr
webr:
  packages: ['ggplot2', 'dplyr', 'readr' , 'palmerpenguins']
---
...
Use a função `rnorm` e crie um objeto chamado cem com cem casos, cuja média seja 30 e o desvio padrão 4. Você pode ver os argumentos da função rnorm usando `?rnorm`
